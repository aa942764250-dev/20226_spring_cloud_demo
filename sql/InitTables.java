...
public class InitTables {
    public static void main(String[] args) throws Exception {
        String url = "jdbc:mysql://154.201.68.122:3306/springcloud_demo?useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true";
        String user = "app_user";
        String pass = "App@Remote2026#User";
        ...
        try (Connection conn = DriverManager.getConnection(url, user, pass)) {
            ...
            System.out.println("\n=== 验证 ===");
            String[] tables = {"user", "customer", "employee", "orders", "contract"};
            for (String t : tables) {
